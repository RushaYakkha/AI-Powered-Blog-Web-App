...
const Header = () => {
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        ...
        {/* Welcome Text */}
        <h2 className='text-3xl sm:text-6xl font-semibold sm:leading-16 text-gray-700'>Write freely, Read <span className='text-primary'>deeply,</span> <br/> Connect meaningfully.</h2>

        {/* Description */}
        <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs
        text-gray-500'>At Blogance, we believe everyone has a story worth sharing. Whether you're here to inspire, inform, or simply express — this is your creative home.</p>
